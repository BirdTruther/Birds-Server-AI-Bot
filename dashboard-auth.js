...
<section class="grid"><article class="card cyan"><div class="icon">&#x1F310;</div><h2>Server Control</h2><p>Choose a server you administer and tune its persona, hate list, roast channel, and alert behavior without touching another community.</p></article><article class="card green"><div class="icon">&#x1F9E0;</div><h2>Memory With Boundaries</h2><p>Server facts stay managed by server admins. Shared facts can be promoted by the owner and recalled by Patrick everywhere.</p></article><article class="card purple"><div class="icon">&#x1F6E1;&#xFE0F;</div><h2>Admin Access</h2><p>Discord verifies who you are and which servers you manage. System logs and global controls stay owner-only.</p></article></section>
